    ...
    return (
        <div className='hidden md:flex bg-white rounded-3xl xl:rounded-full p-4 shadow-lg items-center justify-center gap-8'>
            ...
            <div className='flex-1 flex items-center justify-between flex-wrap'>
                <Link to="/Posts" className='bg-black text-white rounded-full px-4 py-2'>All Posts</Link>
                <Link to="/Posts?cat=%20Web-Designe" className='hover:bg-blue-50 rounded-full px-4 py-2'>Web Design</Link>
